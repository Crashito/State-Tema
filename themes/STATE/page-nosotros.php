            ...
            <div class="container">
                <div class="row align-items-stretch justify-content-center small-screen">
                    <div class="col-12 position-relative page-title-extra-small text-center d-flex align-items-center justify-content-center flex-column">
                        ...
                        <h2 class="text-white alt-font font-weight-500 w-55 md-w-65 sm-w-80 center-col xs-w-100 letter-spacing-minus-1px line-height-50 sm-line-height-45 xs-line-height-30 no-margin-bottom">Estudio Arquitectónico</h2>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-lg-5 offset-lg-1 wow animate__fadeIn" data-wow-delay="0.2s">
                        <h5 class="alt-font text-extra-dark-gray font-weight-500">El trabajo en equipo es lo que hace el trabajo de en sueño.</h5>
                        <p>Con nuestros años de experiencia en diseño y desarrollo de proyectos de vivienda nos enorgullecemos en crear casas únicas con diseño y construcción de calidad.</p>
                        <a href="contact-us-modern.html" class="btn btn-medium btn-fast-blue btn-round-edge">Contáctanos</a>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-12 col-xl-5 col-md-4 text-center text-md-end wow animate__fadeIn" data-wow-delay="0.2s">
                        <a href="contact-us-classic.html" class="btn btn-large btn-round-edge btn-transparent-fast-blue btn-slide-right-bg">Contáctanos<span class="bg-fast-blue"></span></a>
                    </div>
                </div>
            </div>
        </section>
